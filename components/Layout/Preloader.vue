  ...
  <div class="preloader" id="preloader">
    <div class="preloader">
      <div class="waviy position-relative">
        <span class="d-inline-block text-primary">G</span>
        <span class="d-inline-block">A</span>
        <span class="d-inline-block">N</span>
        <span class="d-inline-block text-primary">D</span>
        <span class="d-inline-block">O</span>
        <span class="d-inline-block">U</span>
        <span class="d-inline-block text-primary">R</span>
      </div>
    </div>
  </div>
</template>
...
#preloader .preloader .loader div {
  ...
  border-top-color: #018ea9;
  border-border-bottom: #018ea9;
}
